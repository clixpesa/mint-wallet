    ...
    <YStack width="92%" mt="$sm">
      <XStack justify="space-between">
        <YStack gap="$2xs">
          ...
          <Text variant="subHeading2" color="$neutral1">+1,000</Text>
          </TouchableArea>
          </XStack>
        </YStack>
        <TouchableArea>
          <YStack items="center" bg="$accent2Solid" borderEndEndRadius={16} borderRightWidth={2} borderColor="$surface3">
            <RotatableChevron  direction="right" color="$accent1" />
            <Stack  width="$4xl" items="center" py="$sm" overflow="hidden" >
              <Currency size={54} rotate="-30deg" color="$accent1" opacity={0.9}/>
            </Stack>
          </YStack>
          </TouchableArea>
      </XStack>
