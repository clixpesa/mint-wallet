...
export const ProductsCard = () => {
  return (
    <YStack bg="$surface1" width="100%" px="$sm" pt="$md" pb="$xl" rounded="$lg" gap="$md">
      <Text color="$neutral2" pl="$xs">Some products for you</Text>
      <XStack  items="center" justify="space-between">
        <Stack bg="$greenVibrant" height={42}  rounded="$md" width={42} items="center" justify="center" >
        ...
        <TouchableArea py="$vs" px="$md" bg="$accent2" rounded="$full" onPress={() => router.navigate("/(tabs)/spaces")}>
          <Text variant="buttonLabel2" color="$accent1">Open</Text>
        </TouchableArea>
      </XStack>
      <XStack  items="center"  mt="$sm" justify="space-between">
        <Stack bg="$blueBase" height={42}  rounded="$md" width={42} items="center" justify="center" >
